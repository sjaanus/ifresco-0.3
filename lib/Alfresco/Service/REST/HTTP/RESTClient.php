 ...
 */
set_include_path(realpath(dirname(__FILE_))."/../lib/Alfresco/Service/REST/HTTP/PEAR_PACK/");
...
class RESTClient {
    ...
    public function __construct($ticket="",$lang="en-us") {
        $this->ticket = $ticket;
        $this->lang = $lang;
    }
    ...
    public function sendRequest() {
        $this->req->addHeader("Accept-Language",$this->lang);
