 ...
 */
 require_once(dirname(__FILE__).'/../lib/sfWebFileCache.class.php');
 ...
 */
class sfWebFileCache extends sfCache
{
  const READ_DATA = 1;
  ...
  public function __construct($options=array(),$extension=".swf") {
  ...
  */
  ...
  public function set($key, $data, $lifetime = null)
  {
    ...
    if ($lifetime != null)
        ...
        return $this->write($this->getFilePath($key), $data, null);
  }
  ...
  public function removePattern($pattern)
  {
    ...
    {
      $pattern = str_replace(sfCache::SEPARATOR, DIRECTORY_SEPARATOR, $pattern).$this->extension;
    ...
    {
      $paths = glob($this->getOption('cache_dir').DIRECTORY_SEPARATOR.str_replace(sfCache::SEPARATOR, DIRECTORY_SEPARATOR, $pattern).$this->extension);
    }
  ...
  */
  ...
  {
    return $this->getOption('cache_dir').DIRECTORY_SEPARATOR.str_replace(sfCache::SEPARATOR, DIRECTORY_SEPARATOR, $key).$this->extension;
  }
  ...
  * @throws sfCacheException
  */
  protected function write($path, $data, $timeout=null)
  {
    $current_umask = umask();
    umask(0000);
